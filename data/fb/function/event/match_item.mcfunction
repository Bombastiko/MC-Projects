...
# 3. Step 4 Diagnostic Output
$execute if data storage fb:config {debug:{event:1b}} if data storage fb:tmp event_match{val:1b} run tellraw @a ["", {"text": "  [FB Event Step 4] ", "color": "gold"}, {"text": "Item ID Check: ", "color": "yellow"}, {"text": "MATCH! ", "color": "green", "bold": true}, {"text": "(Required '$(item_id)' == Held '", "color": "gray"}, {"nbt": "event_context.item.id", "storage": "fb:tmp", "color": "aqua"}, {"text": "')", "color": "gray"}]
$execute if data storage fb:config {debug:{event:1b}} if data storage fb:tmp event_match{val:0b} run tellraw @a ["", {"text": "  [FB Event Step 4] ", "color": "gold"}, {"text": "Item ID Check: ", "color": "yellow"}, {"text": "MISMATCH! ", "color": "red", "bold": true}, {"text": "(Required '$(item_id)' != Held '", "color": "gray"}, {"nbt": "event_context.item.id", "storage": "fb:tmp", "color": "white"}, {"text": "')", "color": "gray"}]
