...
# 4. Step 5 Diagnostic Output
$execute if data storage fb:config {debug:{event:1b}} if data storage fb:tmp event_match{val:1b} run tellraw @a ["", {"text": "  [FB Event Step 5] ", "color": "gold"}, {"text": "Custom Data Check: ", "color": "yellow"}, {"text": "MATCH! ", "color": "green", "bold": true}, {"text": "(Required: ", "color": "gray"}, {"nbt": "custom_data", "storage": "fb:tmp current_callback", "color": "light_purple"}, {"text": " == Held: ", "color": "gray"}, {"nbt": "item_cd", "storage": "fb:tmp", "color": "light_purple"}, {"text": ")", "color": "gray"}]
$execute if data storage fb:config {debug:{event:1b}} if data storage fb:tmp event_match{val:0b} run tellraw @a ["", {"text": "  [FB Event Step 5] ", "color": "gold"}, {"text": "Custom Data Check: ", "color": "yellow"}, {"text": "MISMATCH! ", "color": "red", "bold": true}, {"text": "(Required: ", "color": "gray"}, {"nbt": "custom_data", "storage": "fb:tmp current_callback", "color": "yellow"}, {"text": " != Held: ", "color": "gray"}, {"nbt": "item_cd", "storage": "fb:tmp", "color": "white"}, {"text": ")", "color": "gray"}]
