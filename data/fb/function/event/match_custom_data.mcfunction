...
# 2. Extract item's custom_data compound into fb:tmp item_cd
...
# 3. Direct compound match against item_cd in storage
...
# 5. Live debug custom_data matcher report (if verbose matcher debugging is enabled)
