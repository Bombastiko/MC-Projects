...
data modify storage fb:tmp debug_toggle set from storage fb:config debug.sw

# Toggle based on temporary state
execute if data storage fb:tmp {debug_toggle: 1b} run data modify storage fb:config debug.sw set value 0b
execute unless data storage fb:tmp {debug_toggle: 1b} run data modify storage fb:config debug.sw set value 1b
