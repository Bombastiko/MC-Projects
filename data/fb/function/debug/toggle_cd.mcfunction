...
execute if data storage fb:config {debug:{cd:1b}} run data modify storage fb:config debug.cd set value 0b
execute unless data storage fb:config {debug:{cd:1b}} run data modify storage fb:config debug.cd set value 1b
