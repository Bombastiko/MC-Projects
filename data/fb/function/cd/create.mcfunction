...
# Arguments: name, h, m, s, on_complete
...
# Append to db (stores static configuration: command)
$data modify storage fb:main cd.db append value {name: "$(name)", on_complete: "$(on_complete)"}
