...
$execute if score #$(name) fb.cd.t matches ..-1 if score #$(name) fb.cd.m matches 1.. run scoreboard players set #$(name) fb.cd.t 18
$execute if score #$(name) fb.cd.t matches 18 run scoreboard players remove #$(name) fb.cd.m 1
$execute if score #$(name) fb.cd.t matches 18 run scoreboard players set #$(name) fb.cd.t 19
...
$execute if score #$(name) fb.cd.t matches ..-1 if score #$(name) fb.cd.h matches 1.. run scoreboard players set #$(name) fb.cd.t 18
$execute if score #$(name) fb.cd.t matches 18 run scoreboard players remove #$(name) fb.cd.h 1
$execute if score #$(name) fb.cd.t matches 18 run scoreboard players set #$(name) fb.cd.t 19
