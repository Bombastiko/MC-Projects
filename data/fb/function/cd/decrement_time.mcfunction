...
# If seconds > 0
$execute if score #$(name) fb.cd.s matches 1.. run scoreboard players remove #$(name) fb.cd.s 1
$execute if score #$(name) fb.cd.s matches 0.. run scoreboard players set #$(name) fb.cd.t 19
...
$execute if score #$(name) fb.cd.t matches ..-1 if score #$(name) fb.cd.m matches 0.. run scoreboard players set #$(name) fb.cd.s 59
...
$execute if score #$(name) fb.cd.t matches ..-1 if score #$(name) fb.cd.h matches 0.. run scoreboard players set #$(name) fb.cd.m 59
$execute if score #$(name) fb.cd.t matches ..-1 if score #$(name) fb.cd.h matches 0.. run scoreboard players set #$(name) fb.cd.s 59
