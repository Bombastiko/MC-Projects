...
# 5. NONE: displays zeroed timer with configured colors
$execute if data storage fb:tmp anim_check[{type:"none"}] if data storage fb:tmp format_check[{val:"digital"}] run title $(player) actionbar ["", {"text": "$(prefix)", "color": "$(color)", "bold": $(bold)}, {"text": "00", "color": "$(color_num)", "bold": $(bold)}, {"text": ":", "color": "$(color_sec)", "bold": $(bold)}, {"text": "00", "color": "$(color_num)", "bold": $(bold)}, {"text": ":", "color": "$(color_sec)", "bold": $(bold)}, {"text": "00", "color": "$(color_num)", "bold": $(bold)}, {"text": "$(suffix)", "color": "$(color)", "bold": $(bold)}]

$execute if data storage fb:tmp anim_check[{type:"none"}] if data storage fb:tmp format_check[{val:"digital_short"}] run title $(player) actionbar ["", {"text": "$(prefix)", "color": "$(color)", "bold": $(bold)}, {"text": "00", "color": "$(color_num)", "bold": $(bold)}, {"text": ":", "color": "$(color_sec)", "bold": $(bold)}, {"text": "00", "color": "$(color_num)", "bold": $(bold)}, {"text": ".", "color": "$(color_sec)", "bold": $(bold)}, {"text": "00", "color": "$(color_num)", "bold": $(bold)}, {"text": "$(suffix)", "color": "$(color)", "bold": $(bold)}]

$execute if data storage fb:tmp anim_check[{type:"none"}] if data storage fb:tmp format_check[{val:"letters"}] run title $(player) actionbar ["", {"text": "$(prefix)", "color": "$(color)", "bold": $(bold)}, {"text": "0", "color": "$(color_num)", "bold": $(bold)}, {"text": "h ", "color": "$(color_sec)", "bold": $(bold)}, {"text": "0", "color": "$(color_num)", "bold": $(bold)}, {"text": "m ", "color": "$(color_sec)", "bold": $(bold)}, {"text": "0", "color": "$(color_num)", "bold": $(bold)}, {"text": "s", "color": "$(color_sec)", "bold": $(bold)}, {"text": "$(suffix)", "color": "$(color)", "bold": $(bold)}]

$execute if data storage fb:tmp anim_check[{type:"none"}] if data storage fb:tmp format_check[{val:"dynamic"}] run title $(player) actionbar ["", {"text": "$(prefix)", "color": "$(color)", "bold": $(bold)}, {"text": "0", "color": "$(color_num)", "bold": $(bold)}, {"text": "s", "color": "$(color_sec)", "bold": $(bold)}, {"text": "$(suffix)", "color": "$(color)", "bold": $(bold)}]
